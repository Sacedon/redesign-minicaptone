...
">
    <div class="d-flex justify-content-between align-items-center">
        <div class="text-white">
            ...
            ">
                <i class="fa-solid fa-prescription-bottle"></i> Your Milk Tea Shop
            </h1>
        </div>
        <div class="text-white">
            <nav>
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link text-white" href="/dashboard"><i class="fa-solid fa-prescription-bottle"></i> Menu</a>
                    </li>
                    @role('admin')
                    <li class="nav-item">
                        <a class="nav-link text-white" href="/logs"><i class="fas fa-history"></i> Logs</a>
                    </li>
                    @endrole
                </ul>
            </nav>
            ...
            <div style="place-content: center;" class="d-flex flex-wrap">
                        ...
                        <form action="{{ route('plugin.download', $plugin) }}" method="POST">
                            ...
                            <div class="action-button">
                                ...
                                <button class="btn btn-primary" data-plugin-id="{{ $plugin->id }}" onclick="submitOrderForm(this)">
                                    <i class="fa fa-coffee"></i> Order Now
                                </button>
                                @endrole
                            </div>
                        </form>
                ...
                {{-- <div class="m-5">
                    <div class="bg-light p-5 rounded" style="
                        ...
                        background-color: #D2B48C; /* Coffee Brown */
                    ">
                        ...
                        <div class="text-center mb-5">
                            <img width="300px;" src="https://gringo.ph/cdn/shop/products/BagoongSweetspicy_1024x1024.png?v=1606203989" alt="">
                        </div>
